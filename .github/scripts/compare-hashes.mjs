 ...
 *
 *   hashes-dir:   Directory containing hash files to compare (anywhere in the directory hierarchy)
 ...
 * - Hashes are expected to be grouped by optimization level
...
async function compareAll(files, optLevels) {
    ...
    // Sort by platform name (byte-order, not `localCompare()`) for deterministic reference selection.
