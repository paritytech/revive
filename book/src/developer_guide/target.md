...
`pallet-revive` exposes a [syscall like interface](https://docs.rs/pallet-revive/0.10.1/pallet_revive/trait.SyscallDoc.html) for contract interactions with the host environment. This is provided by the [revive-runtime-api](https://crates.io/crates/revive-runtime-api) library. 
